...
そして，正規化した各モーションデータのそれぞれ30\%に，VincentらによるStacked Denoising Autoencoderの研究\cite{4-sda}において実数データに対するノイズ付加方法として自然な選択であると説明されている，平均が0で分散が1のガウシアンノイズによるノイズ加工を行う．
